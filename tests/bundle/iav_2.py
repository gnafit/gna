...
# Initialize bundle
#
cfg = NestedDict( ndiag = 1)
par1 = env.defparameter( 'ad1.OffdiagScale',  central=1.5, relsigma=0.1 )
par2 = env.defparameter( 'ad2.OffdiagScale',  central=0.5, relsigma=0.1 )
(esmear1,esmear2), _ = detector_iav_from_file( 'output/detector_iavMatrix_P14A_LS.root', 'iav_matrix',
