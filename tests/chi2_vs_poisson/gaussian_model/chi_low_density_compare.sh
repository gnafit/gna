...
-- contour --chi2 $(pwd)/tests/chi2_vs_poisson/gaussian_model/tmp/scan_chi.hdf5     --minimizer chi_min1 --plot  chi2minplt --labels "chi2 asdata"   --legend upper right \
	 --output $(pwd)/tests/chi2_vs_poisson/gaussian_model/img/low_den_chi2_compare.png \
#-- spectrum --plot peak1/spectrum --savefig $(pwd)/tests/chi2_vs_poisson/gaussian_model/img/chi2_low_spectrum.png
