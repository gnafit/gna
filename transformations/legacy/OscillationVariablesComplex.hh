...
class OscillationVariablesComplex: public ParametersGroup {
public:
  OscillationVariablesComplex(GNAObject *parent)
    : ParametersGroup(parent, fields())
    { }
  OscillationVariablesComplex(GNAObject *parent, std::vector<std::string> params)
    : OscillationVariablesComplex(parent)
    { initFields(params); }
...
public:
  OscillationExpressions()
    : ExpressionsProvider(new OscillationVariablesComplex(this))
    { }
};
