...
double InterpLinear::interpolation_formula_below(double x, double y, double k, double point) const noexcept {
    return k * (point - x) + y;
}

double InterpLinear::interpolation_formula_above(double x, double y, double k, double point) const noexcept {
    return k * (point - x) + y;
}
