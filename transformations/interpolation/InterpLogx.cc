...
double InterpLogx::interpolation_formula_below(double x, double y, double k, double point) const noexcept {
       return k * std::log(point/x) + y;
}

double InterpLogx::interpolation_formula_above(double x, double y, double k, double point) const noexcept {
       return k * std::log(point/x) + y;
}
