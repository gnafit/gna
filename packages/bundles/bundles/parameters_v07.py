...
class parameters_v07(TransformationBundle):
    """Parameters v07 bundle
        ...
        Changes since parameters_v06:
        - add an option to create a nested parameters, defined as nested dictionaries, but not via indices
    """
    ...
    def define_variables(self):
        ...
        maxdepth = self.cfg.get('depth', 1)
        for name in pars.walkkeys(maxdepth=maxdepth):
            if name[0] in skip:
                continue
