...
class exp(baseexp):
    """\
JUNO+TAO experiment implementation v04i

Presented on 2021-04-19

Changes since junotao_v04i:

Changes since junotao_v04f:
    - Temporarily:
      + comment TAO until the enu_matrix/enu_subst are correctly dispatched
      + disable spectral uncertainties
    - Switch to the new binning by Jinnan
      * 0.8-0.94 MeV, 1 bin;
      * 0.94-7.44 MeV, 20keV, 325 bins;
      * 7.44-7.8 MeV, 40 keV, 9 bins;
      * 7.8-8.2 MeV, 100 keV, 4 bins;
      * 8.2-12 MeV, 1 bin.
      * Totally 340 bins.
