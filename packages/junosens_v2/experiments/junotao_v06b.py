...
class exp(baseexp):
    """\
JUNO+TAO experiment implementation v06b
To be presented on Monday 2021-12-24

Changes since junotao_v06a:
    + TAO:
        - New binning:
            * start from 0.8 MeV
            * same as JUNO
    + JUNO and TAO
        - due to TAO binning synchronized to JUNO, enu segments for E>8 MeV are moved, causing negligible deviation in the tail
...
"""
    ...
    def init_formula(self):
        ...
        self.formula = [
            ...
            "livetime_tao=bracket(duty_cycle_tao*veto_livetime_fraction_tao*daq_years_tao*seconds_in_year)",
            "conversion_factor",
            ...
            # "lsnl_switch_tao| lsnl_x_tao(), lsnl_coarse_tao",
            ...
            # Eres TAO
            "eres_sigmarel_tao_fine_base| eres_tao_e_coarse(), binning_smear_noquench_centers(evis_hist_noquench)",
            "eres_sigmarel_tao_fine| eres_tao_sigmarel_coarse()",
            "eres_sigmarel_input_tao| eres_sigmarel_tao_fine()",
            #
            # Neutrino energy
            #
            ...
            #
            "cmp_rebin_tao_raw| rebin_tao_internal()",
            "cmp_rebin_tao_eleak| eleak_tao()",
            "cmp_rebin_tao_lsnl| lsnl_tao()",
            "cmp_rebin_tao_eres| eres_tao()",
            # TAO backgrounds
            "cmp_tao_accidentals = acc_num_tao    * acc_spectrum_tao()",
            "cmp_tao_fastn       = fastn_num_tao  * fastn_spectrum_tao()",
            "cmp_tao_lihe        = lihe_num_tao   * lihe_spectrum_tao()",
    ...
    def init_configuration(self):
        ...
        common_input_root_file_tao = "TAOInputs2021_11_29_upd.root"
        ...
        self.cfg = NestedDict(
            ...
            # lsnl_switch=dict(
            #     bundle=dict(name="switch", version="v01", names={"condition": "lsnl_switchvar"}),
            #     instances={
            #         "lsnl_switch_juno": "JUNO LSNL disabled (0) or enabled (1)",
            #         "lsnl_switch_tao": "TAO LSNL disabled (0) or enabled (1)",
            #     },
            #     varlabel="cosθ(=/≠)0 switch",
            #     ninputs=2,
            #     default=1,
