...
class exp(baseexp):
    """
JUNO+TAO experiment implementation v01
...
Changes since previous implementation [juno_sensitivity_v03_common]:
    - [2020.10.01] Refactor formula in order to detach JUNO specific constants
    ...
    def init_configuration(self):
        ...
        self.cfg = NestedDict(
                ...
                eleak_tao = dict(
                    ...
                    filename   = 'data/data_juno/data-joint/2020-06-11-NMO-Analysis-Input/JUNOInputs2020_10_29.root',
                ...
                offeq_correction = dict(
                        ...
                        offeq_data = 'data/data_juno/data-joint/2020-06-11-NMO-Analysis-Input/JUNOInputs2020_10_29.root',
                ...
                snf_correction = dict(
                        ...
                        snf_average_spectra = 'data/data_juno/data-joint/2020-06-11-NMO-Analysis-Input/JUNOInputs2020_10_29.root',
