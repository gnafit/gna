...
class exp(baseexp):
    """\
JUNO+TAO experiment implementation v05d

Based on version v05c. Updates:
    + JUNO, TAO
        - Switch to var-20 binning by default
...
"""
    ...
    def init_formula(self):
        ...
        self.formula = [
                ...
                'eres_sigmarel_input| sigma_correction_fine()*eres_sigmarel| binning_smear_centers()' if not self.opts.consistency_eres else '',
                'eres_sigmarel_input| eres_sigmarel| binning_smear_centers()' if self.opts.consistency_eres else '',
                ...
                'bkg_shape_variance_tao = bin_width_factor * bkgbin_tao_widths(accidentals_tao) * sumsq_bkg_tao| lihe_bin2bin*lihe_tao, fastn_bin2bin_tao*fastn_sigma_tao',
                #
                # IBD part
                #
