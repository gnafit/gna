...
Presented on 2021-04-12

Changes since junotao_v04g:
    - Update LSNL treatment (energy_nonlinearity_db_root_subst_v02):
        * User proper extrapolation for both matrix and substitution approaches
        * Supersample the input curve
    - Update the total rate by taking into account H₁ fraction (juno_target_mass_v1).
...
"""
    ...
    def init_configuration(self):
        ...
        if self.opts.comparison:
            ...
            anue_spec_unc_edges = np.concatenate([a, np.arange(2.0, 8.01, 0.010), c], dtype='d')
