...
class exp(baseexp):
    """\
JUNO+TAO experiment implementation v04

Used for the comparison on 01.02.2021

Changes since junotao_v03:
    - Add switches for the bin-to-bin uncertainties                         [2021-02-01]
...
"""
    ...
    nameslib = open('packages/junosens_v2/experiments/junotao_v04.yaml', 'r').read()
    @classmethod
    ...
    def init_formula(self):
        ...
        self.formula = [
                ...
                # Backgrounds in JUNO
                #
                'acc_num    = days_in_second * efflivetime * acc_rate    * acc_rate_norm',
                'fastn_num  = days_in_second * efflivetime * fastn_rate  * fastn_rate_norm',
                'alphan_num = days_in_second * efflivetime * alphan_rate * alphan_rate_norm',
                'lihe_num   = days_in_second * efflivetime * lihe_rate   * lihe_rate_norm',
                'geonu_num  = days_in_second * efflivetime * geonu_rate  * geonu_rate_norm',
                #
    ...
    def init_configuration(self):
        ...
        self.cfg = NestedDict(
                ...
                bkg_rate = dict(
                        bundle = dict(name="parameters", version = "v06"),
                        pars = f'{common_input_location}/deprecated/files/bkg_rates_v1.yaml',
