...
class exp(baseexp):
    """\
JUNO+TAO experiment implementation v04c

Results presented on 2021-03-02

Changes since junotao_v04b:
    - New common input file (downgraded cross section, VB)
    - Parameters update:
      * duty_cycle applied to the thermal_power, not reactor livetime

Derived from:
    - [2021.22] junotao_v04b
    - [2021.02] junotao_v04
    - [2021.01] junotao_v03
    - [2020.12] junotao_v02
    - [2020.12] junotao_v01
...
"""
    ...
    def initparser(cls, parser, namespace):
        ...
        parser.add_argument('--xsec', choices=['vogel', 'dyb'], default='dyb', help='IBD cross section')
    ...
    def init_configuration(self):
        ...
        common_input_root_file='deprecated/JUNOInputs2021_02_23.root'
        self.cfg = NestedDict(
                #
                # Numbers
                #
