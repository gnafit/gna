...
Presented on 2021.03.15

Changes since junotao_v04d:
    - TODO: Switch to the MSW oscprob by Khan et al.
...
"""
    ...
    def initparser(cls, parser, namespace):
        ...
        parser.add_argument('--msw', choices=['khan-approx', 'juno-yb'], default='juno-yb', help='MSW oscillation option')
