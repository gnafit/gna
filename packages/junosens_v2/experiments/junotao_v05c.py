...
class exp(baseexp):
    """\
JUNO+TAO experiment implementation v05c

Presented on 2021-07-20 on collaboration meeting 18.

Based on version v05b. Updates:
    + JUNO
        * Switch to the tentative common inputs file JUNOInputs2021_05_28_upd.root
        * Switch to the updated energy resolution juno_eres_v3.yaml
        * Add an extra correction for the energy resolution σ/E
        * Disable HZ contribution.
        * Add LBL nuclear reactors L<2000 km (excluding HZ/Daya Bay already taken into account)
        * Add LBL nuclear reactors L>2000 km as a background with
            - rate uncertainty
            - bin-2-bin shape uncertainty [bkg_bin2bin_v2.yaml]
        * Switch SNF uncertainty from uncorrelated 100% to correlated 30%
    + TAO
        * To be done in next version:
            - HM fine spectrum and uncertainties
    + Add consistency options to enable v05b behavior:
        * --consistency-eres
        * --consistency-hz
        * --consistency-lbl/--disable-lbl
...
"""
    ...
    def initparser(cls, parser, namespace):
        ...
        binning.add_argument('--binning-tao', default='var-40', choices=binnings, help='base tao binning')
