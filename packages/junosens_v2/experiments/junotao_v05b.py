...
class exp(baseexp):
    """\
JUNO+TAO experiment implementation v05b

Based on version v05a.
Updates:
    + JUNO
        * Switch to the new common inputs file
            - proper accidentals spectrum interpolation
        * Updated accidentals rate
    + TAO
        * Binning:
            - Add 3 options for antineutrino spectrum binning starting from 20, 30 and 40 keV
        * Fixed the energy leakage application: due to improper normalization it was loosing half of the events
        * Backgrounds:
            - Introduce Li/He bin-2-bin uncertainty via nuisance parameters
            - Introduce Fast neutrons uncertainty via nuisance parameters
        * To be done in next version:
            - HM fine spectrum and uncertainties
...
"""
    ...
    def initparser(cls, parser, namespace):
        ...
        binning.add_argument('--binning-tao', type=int, default=40, choices=(20, 30, 40), help='base tao binning')
    ...
    def init_configuration(self):
        ...
        common_input_root_file='JUNOInputs2021_05_28.root'
        self.cfg = NestedDict(
                #
                # Numbers
                #
                ...
                bkg_rate = dict(
                        bundle = dict(name="parameters", version = "v06"),
                        pars = f'{common_input_location}/files/bkg_rates_v5.yaml',
    ...
    def init_tao_binning(self):
        opt = self.opts.binning_tao
        fname = f'data/local/tao-binning-v05b-{opt}.dat'
