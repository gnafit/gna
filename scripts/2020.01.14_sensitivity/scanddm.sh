...
function syst {
    ...
    run "+YB oscpars*"          vac_lsnl_meres    vacuum "lsnl multieres --subdetectors-number 5 --multieres concat" parameters=yb  transient        unctheta         spectrum=initial covpars="juno.norm juno.pmns.SinSqDouble13           juno.thermal_power juno.spectrum juno.subdetector_fraction juno.Npescint juno.kC juno.birks"
