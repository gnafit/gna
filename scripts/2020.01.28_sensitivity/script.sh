...
outputdir=output/2020.01.28_sensitivity
...
function syst {
    ...
    run 204 "x2 bins"               vac_lsnl_meres    vacuum "lsnl multieres --subdetectors-number 5 --multieres concat --estep 0.01"   unctheta         spectrum=initial covpars="juno.norm juno.pmns.SinSqDouble13           juno.thermal_power juno.spectrum juno.subdetector_fraction juno.Npescint juno.kC juno.birks"
    run 210 "Meres+LSNL, matter"    mat_lsnl_meres    matter "lsnl multieres --subdetectors-number 5 --multieres concat --estep 0.01"   unctheta         spectrum=initial covpars="juno.norm juno.pmns.SinSqDouble13           juno.thermal_power juno.spectrum juno.subdetector_fraction juno.Npescint juno.kC juno.birks"
}
syst
