...
identity = R.Identity()
id2 = R.Identity()
identity.identity.switchFunction("GPU")
id2.identity.switchFunction("GPU")
...
b_id2 = R.Identity()
b_identity.identity.switchFunction("GPU")
b_id2.identity.switchFunction("GPU")

b_identity.identity.source( points2.points.points )
