...
from thirdparty.chengyp.exp.nl_reactor import ReactorExperimentModel, Reactor, Detector
import numpy as np
import ROOT
...
class cmd(basecmd):
    ...
    def init(self):
        ...
        ReactorExperimentModel(self.opts, reactors=reactors, detectors=detectors)
