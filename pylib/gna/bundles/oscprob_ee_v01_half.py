"""Oscillation probability Pee bundle v01 (half).

Based on oscprob_v01_half. Updates:
"""
...
class oscprob_ee_v01_half(TransformationBundle):
    def __init__(self, *args, **kwargs):
        TransformationBundle.__init__(self, *args, **kwargs)
        self.check_nidx_dim(1, 2, 'major')

        try:
            source_name, component_name = self.cfg.bundle.major
        except:
            raise Exception('Unable to obtain major indices: source and OP component')
    ...
    def build(self):
        ...
        for it_source in self.idx_source:
            ...
            for reactor in self.cfg.reactors:
                if reactor in it_dist.current_values():
                    ...
                    with self.namespace(pmns_name):
                        for it_minor in self.nidx_minor:
                            ...
                            for it_component in self.idx_component:
                                ...
                                it = it_source+it_component+it_minor
                                if component=='comp0':
