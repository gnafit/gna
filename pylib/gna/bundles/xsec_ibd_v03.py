...
class xsec_ibd_v03(TransformationBundle):
    """Inverse beta-decay cross section from Vogel&Beacom
    Changes since xsec_ibd_v02:
        - Removed parameters initialization: to be initialized explicitly
        - As a result the bundle is initialized in the current namespace (namespace 'ibd' is not used)
    """
