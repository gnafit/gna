...
class Expression_v01(object):
    operations = dict(sum=OSum, prod=OProd, concat=OConcat, accumulate=Accumulate, Accumulate=AccumulateTrans, bracket=bracket, expand=expand, inverse=OInverse, select1=OSelect1 )
    tree = None
