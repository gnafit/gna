...
class reactor_anu_corr_v01(TransformationBundle):
    debug = False
    def __init__(self, **kwargs):
        super(reactor_anu_corr_v01, self).__init__( **kwargs )
    ...
    def build(self):
        ...
        for name, vars in self.corr_vars.items():
            with self.common_namespace:
                ...
                corrpar_t = R.WeightedSum(1.0, C.stdvector(['offset']), C.stdvector([self.cfg.uncname]))
