...
-- analysis --name inv_inv -d asimov_ih  pull_sin_13_i  \
   -o juno_ih/AD1  \
...
-- scan --lingrid juno_ih.oscillation.DeltaMSqEE  2.44e-3 2.54e-3 150 \
...
-- analysis --name nor_inv -d asimov_nh pull_sin_13_n  \
   -o juno_nh/AD1  \
...
-- scan --lingrid juno_nh.oscillation.DeltaMSqEE  2.42e-3 2.58e-3 150 \
