...
python gna gaussianpeak --name two_peaks --nbins 200 --npeaks 2 \
    ...
    -- scan --lingrid two_peaks1.Mu -20 50 70 --lingrid two_peaks0.Mu -20 50
70 --verbose --minimizer min --output /tmp/two_gaus.hdf5 \
-- contour --chi2 /tmp/two_gaus.hdf5 --plot chi2ci 1s --minimizer min --show
