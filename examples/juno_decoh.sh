...
-- juno --name juno_stand --oscprob standard -- ns --value juno_stand.oscillation.Alpha normal \
-- juno --name juno_decoh --oscprob decoh    -- ns --value juno_decoh.oscillation.Alpha normal \
